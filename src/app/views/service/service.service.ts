...
export class ServiceService {
  ...
  testPrint(renderer: Renderer2): void {
    ...
    this.printService
      .clearPrintBlank()
      .addQrCode(renderer, 'This is my test')
      .addTextToPrint(renderer, 'Привет')
      .addTextToPrint(renderer, 'Гончара')
      .addTextToPrint(renderer, 'Дом 3')
      .addTextToPrint(renderer, 'Hello')
      .addTextToPrint(renderer, '------------')
      .addTextToPrint(renderer, '   ф ф Ш Ї їЩ')
      .addTextToPrint(renderer, ' IД 34554362   ')
